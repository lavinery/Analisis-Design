                ...
                <div class="banner-text">
                    ...
                    <table class="table-list" border="1">
                        ...
                        <tr>
                            ...
                            <td><?php if ($data['lomba'] == "ic") {
                                        echo "Informatics Championship";
                                    } else if ($data['lomba'] == "stec") {
                                        echo "Soedirman Technophoria";
                                    } else if ($data['lomba'] == "lustrum") {
                                        echo "Lustrum 5.0";
                                    } ?></td>
                            <td><?php if ($data['status'] == "Pending") {
                                        echo "<span class='button-pending'>Pending</span>";
                                    } else if ($data['status'] == "Rejected") {
                                        echo "<span class='button-rejected'>Reject</span>";
                                    } else if ($data['status'] == "Accepted") {
                                        echo "<span class='button-accepted'>Accepted</span>";
                                    } ?></td>
                            <td>
