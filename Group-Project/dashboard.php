    ...
    <div class="sidebar">
        <div class="sidebar-content">
            ...
            <ul>
                ...
                <?php if (in_array($_SESSION['level'], ["Administrator", "Staff", "Owner"])) : ?>
                    <a onclick="insertArticle();" id="sidebarInsert">
                        <li><i class="fa-solid fa-newspaper"></i> Tambah Artikel</li>
                    </a>
                    <?php if ($_SESSION['level'] == "Owner") : ?>
                        <a onclick="listArticle();" id="sidebarArticle">
                            <li><i class="fa-solid fa-newspaper"></i> List Artikel</li>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['level'] == "Member") : ?>
                        ...
                        if (mysqli_num_rows($query) == 0) : ?>
                            <a onclick="insertCommitte();" id="sidebarInsertCommitte">
                                <li><i class="fa-solid fa-user"></i> Daftar Kepanitiaan</li>
                            </a>
                        <?php endif; ?>
                    <?php elseif ($_SESSION['level'] == "Staff" || $_SESSION['level'] == "Owner" || $_SESSION['level'] == "Administrator") : ?>
                        <a onclick="insertCommitte();" id="sidebarInsertCommitte">
                            <li><i class="fa-solid fa-user"></i> Daftar Kepanitiaan</li>
                        </a>
                    <?php endif; ?>

                    <?php if (in_array($_SESSION['level'], ["Owner", "Staff"])) : ?>
                        <a onclick="listCommittes();" id="sidebarCommittes">
                            <li><i class="fa-solid fa-users"></i> Daftar Panitia</li>
                        </a>
                    <?php endif; ?>

                    <?php if ($_SESSION['level'] == "Owner") : ?>
                        <a onclick="listUsers();" id="sidebarUsers">
                            <li><i class="fa-solid fa-users"></i> Daftar User</li>
                        </a>
                        <a onclick="listProgram();" id="sidebarProgram">
                            <li><i class="fa-solid fa-list-check"></i> Daftar Proker</li>
                        </a>
                        <a onclick="listDivision();" id="sidebarDivision">
                            <li><i class="fa-solid fa-list-check"></i> Daftar Divisi</li>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
    ...
    <div class="dashboard-section">
        ...
        <div class="dashboard-content" id="insert-article" style="display:none">
            <?php if ($_SESSION['level'] == "Administrator" || $_SESSION['level'] == "Staff" || $_SESSION['level'] == "Owner") { ?>
                ...
                <div class="dashboard-input">
                    <form name="change-password" action="process.php" method=artikel"POST" enctype="multipart/form-data">
        ...
        <div class="dashboard-content" id="update-article" style="display:none">
            <?php if ($_SESSION['level'] == "Owner" || $_SESSION['level'] == "Staff") { ?>
        ...
        <div class="dashboard-content" id="insert-committe" style="display:none">
            <?php if ($_SESSION['level'] == "Owner" || $_SESSION['level'] == "Staff" || $_SESSION['level'] == "Administrator") { ?>
                <h2>Daftar Kepanitiaan</h2>
                <span>Diharapkan untuk memasukkan data secara seksama dan teliti!</span>
                <div class="dashboard-input">
                    <form name="change-password" action="process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="insert-committe" value="Daftar">
                    </form>
                </div>
        </div>
    <?php } ?>
    <div class="dashboard-content" id="list-committes" style="display:none">
        <?php if ($_SESSION['level'] == "Staff" || $_SESSION['level'] == "Owner" || $_SESSION['level'] == "Administrator") { ?>
