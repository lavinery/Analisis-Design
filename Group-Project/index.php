...
<body>
    ...
    <div class="hero-section" id="hero-section">
        <div class="content">
            ...
            <p class="type">Suatu kabinet pada organisasi kemahasiswaan jurusan Informatika di Fakultas Teknik yang
                terintegrasi dengan Universitas Jenderal Soedirman.</p><br>
        ...
        <div class="floating-content">
            <div class="floating-items">
                <ul>
                    ...
                    <li>
                        <p>Satu Informatika untuk satu Indonesia.</p>
                    </li>
                </ul>
                ...
                <div class="item">
                    <ul>
                        ...
                        <li>
                            ...
                            <p>Himpunan Mahasiswa Informatika Universitas Jenderal Soedirman adalah organisasi
                                kemahasiswaan dilingkungan jurusan Informatika Fakultas Teknik Universitas Jenderal
                                Soedirman yang merupakan bagian integral dari rakyat Indonesia.</p>
                            <p>Memiliki visi dalam mewujudkan mahasiswa yang bertakwa kepada Tuhan Yang Maha Esa,
                                berwawasan luas, cendekia bermoral, berintefritas, berpikir kritis, berpribadian baik,
                                bertanggung jawab serta berkepedulian sosial untuk terciptanya kehidupan kampus yang
                                ilmiah dan bermanfaat dalam satu kesatuan organisasi yang terstruktur.</p><br>
    ...
    <div class="article-section" id="article-section">
        <div class="article-content">
            <div class="article-items">
                <h2><a href="article.php" style="text-decoration:none;color:white">Article </a><span> Himpunan Mahasiswa
                        Informatika</span></h2>
