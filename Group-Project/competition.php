        ...
        <div class="sub-container">
            <div class="main-banner">
                <div class="banner-text">
                    <h4><a href="index.php"><i class="fa-solid fa-arrow-left"></i></a> <em>Registration</em> Competition
                    </h4>
                    <form name="register-competition" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST"
                        class="register-competition">
                        <label>Nama</label>
