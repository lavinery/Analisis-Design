        ...
        <div class="dashboard-content" id="update-article">
            ...
            <div class="dashboard-input">
                ...
                <form name="update-article" action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="article-title" placeholder="Harap masukan judul konten .."
                        value="<?php echo $data['judul_konten']; ?>" required>
                ...
                <form name="update-committe" action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="committe-name" placeholder="Nama" value="<?php echo $data['nama']; ?>"
                        required>
                    <label>Email Panitia</label>
                    <input type="email" name="committe-email" placeholder="Email" value="<?php echo $data['email']; ?>"
                        required>
                    <label>NIM Panitia</label>
                    <input type="text" name="committe-nim" placeholder="NIM" value="<?php echo $data['nim']; ?>"
                        style="text-transform:uppercase" required>
                    <label>Nomor Telepon Panitia</label>
                    <input type="text" name="committe-number" placeholder="Nomor Telepon"
                ...
                <form name="update-user" action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="user-name" placeholder="Nama" value="<?php echo $data['nama']; ?>"
                        required>
                    <label>Email Pengguna</label>
                    <input type="email" name="user-email" placeholder="Email" value="<?php echo $data['email']; ?>"
                        required>
                    <label>Username Pengguna</label>
                    <input type="text" name="user-username" placeholder="Nama" value="<?php echo $data['username']; ?>"
                        required>
                ...
                <form name="update-user" action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="program-name" placeholder="Nama"
                        value="<?php echo $data['nama_proker']; ?>" required>
                ...
                <form name="update-user" action="process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="division-name" placeholder="Nama"
                        value="<?php echo $data['nama_divisi']; ?>" required>
